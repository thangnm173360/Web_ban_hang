...
<body>
                    ...
                    <div class="col-sm-6">
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                <li><a href="#"><i class="fa fa-phone"></i> 0936960414</a></li>
                                <li><a href="#"><i class="fa fa-envelope"></i> luongduyanh1999@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a href="{{URL::to('/admin')}}"><i class="fa fa-star"></i> Kênh người bán</a></li>
                                <?php
    ...
    <div id="fb-root"></div>
    <div id="fb-root"></div>
    <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v9.0&appId=474378460191872&autoLogAppEvents=1" nonce="jK9mD5GP"></script>
