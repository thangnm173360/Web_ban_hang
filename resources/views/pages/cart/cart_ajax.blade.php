...
<section id="cart_items">
	<div class="container">
		...
		@endif
		<div class="table-responsive cart_info" style="width: 86.5%">
						...
						<tr>
							...
							<td colspan="2">
								...
								<li>
									...
									<p>
								<li>Tổng đã giảm :{{number_format($total-$total_coupon,0,',','.')}} VNĐ</li>
								</p>
								...
								<p>
									<li>Tổng đã giảm :{{number_format($total_coupon,0,',','.')}} VNĐ</li>
								</p>
								@endif
								@endforeach
