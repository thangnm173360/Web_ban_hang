            ...
            <div id="sidebar" class="nav-collapse">
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        <li>
                            <a class="active" href="{{URL::to('/dashboard-admin')}}">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                            <li><a href="{{URL::to('/users')}}">Duyệt cửa hàng</a></li>
                                <li><a href="{{URL::to('/users-shop')}}">Liệt kê cửa hàng</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                ...
                                <li><a href="{{URL::to('/users-admin')}}">Danh sách admin</a></li>
                            </ul>
                        </li>
