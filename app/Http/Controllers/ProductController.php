...
class ProductController extends Controller
{
    ...
    public function add_product()
    {
        ...
        $cate_product = DB::table('tbl_category_product')
            ->where('shop_id', Session()->get('admin_id'))->orderby('category_id', 'desc')->get();
        $brand_product = DB::table('tbl_brand')
            ->where('shop_id', Session()->get('admin_id'))->orderby('brand_id', 'desc')->get();
    ...
    public function all_product()
    {
        ...
        $all_product = DB::table('tbl_product')
            ...
            ->join('tbl_admin', 'tbl_admin.admin_id', '=', 'tbl_product.shop_id')
            ->where('tbl_product.shop_id', Session()->get('admin_id'))
            ->orderby('tbl_product.product_id', 'desc')->paginate(4);
        $manager_product  = view('admin.product.all_product')->with('all_product', $all_product);
        return view('shop_layout')->with('admin.product.all_product', $manager_product);
    }
    ...
    public function save_product(Request $request)
    {
        ...
        $data['shop_id'] = Session()->get('admin_id');
    ...
    public function edit_product($product_id)
    {
        ...
        return view('shop_layout')->with('admin.product.edit_product', $manager_product);
    }
    ...
    public function details_product($product_slug, Request $request)
    {
        ...
        $related_product = DB::table('tbl_product')
            ->join('tbl_category_product', 'tbl_category_product.category_id', '=', 'tbl_product.category_id')
            ->join('tbl_brand', 'tbl_brand.brand_id', '=', 'tbl_product.brand_id')
            ->where('tbl_category_product.category_id', $category_id)->whereNotIn('tbl_product.product_slug', [$product_slug])
