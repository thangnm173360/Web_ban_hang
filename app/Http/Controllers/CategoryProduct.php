...
class CategoryProduct extends Controller
{
    ...
    public function all_category_product()
    {
        ...
        $all_category_product = DB::table('tbl_category_product')
            ->where('shop_id', Session()->get('admin_id'))->paginate(4);
        $manager_category_product  = view('admin.category.all_category_product')
            ->with('all_category_product', $all_category_product);
        return view('shop_layout')->with('admin.category.all_category_product', $manager_category_product);
    }
    ...
    public function edit_category_product($category_product_id)
    {
        ...
        return view('shop_layout')->with('admin.category.edit_category_product', $manager_category_product);
    }
